              ...
              <div class="panel-body">
                <form>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter IR no here">
                  </div>
                  <div class ="form-group">
                  ...
                  <div class ="form-group">
                      <label>CC</label>
                      <input type="email" class="form-control" placeholder="anotherexample@email.com">
                    </div>
                  <div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="affectedsite" id="sel1">
                      <option value="SPiParañaque">SPi Parañaque</option>
                      <option value="SPiDumaguete">SPi Dumaguete</option>
                      <option value="SPiLaguna">SPi Laguna</option>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="SPi Owned/Client" value="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="i.e Avention 40/Preqin 20">
                    </div>
                  <div class="form-group">
                    <label>Details</label>
