...
<html lang="en">
  <head>
    ...
    <title>SPi Service Desk Previous IR</title>
    <!-- Bootstrap core CSS -->
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">Previous Incident Reports</li>
        </ol>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="previousIR.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Previous Incident Reports <span class="badge">33</span></a>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Previously filed Incident Reports</h3>
              </div>
